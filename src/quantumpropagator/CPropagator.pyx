...
#
#
#cdef Checkaddress1D(double time, double complex [:,:] GRID,dict inp, int selector):
#    cdef:
#        int s,t,theL=inp['theL'],nstates=inp['nstates']
#        int d,carte,k
#        double dthe=inp['dthe'],V,Ab
...
#        double complex dG_dt, d2G_dt2, G, dG_dt_oth
#        double complex Ttt
#        double complex Ttot,Vtot
#
#    new = np.empty_like(GRID)
#    kinS = np.empty_like(GRID)
#    potS = np.empty_like(GRID)
#
#    values_big = np.zeros(100000) #complex
#    i_big = np.zeros(100000) #integers
#    j_big = np.zeros(100000) #integers
#
#    k = 0
#
#    for t in range(theL):
...
#            k = k + 1
#
#            value1 = (-(30.0/12) * Km[t,8,2] / (dthe**2)) + V
#            add1   = transform(t,s)
#            values_big[k] = value1
#            i_big[k] = i_add
#            j_big[k] = add1
...
#
#            # T elements (9)
#            # Ttt = Km[t,8,0] * GRID[t,s] + Km[t,8,1] * dG_dt + Km[t,8,2] * d2G_dt2
#            # Ttt = -0.0000001 * d2G_dt2
#
#            # Ttot = Ttt
#            # Vtot = V * GRID[t,s]
#
#            # new[t,s] = I * (Ttot + Vtot)
#    return(values_big,i_big,j_big,k-1)
#
